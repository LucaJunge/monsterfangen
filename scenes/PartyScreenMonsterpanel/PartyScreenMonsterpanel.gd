...
func set_info(_sprite = "res://assets/interface/missingno.png", _monster_name = "MISSINGNO", _monster_level = "-1", _monster_gender = "X", _monster_current_health = "?", _monster_health = "?" ):
	...
	monster_hp.set_text(str(_monster_current_health)+ " / " + str(_monster_health))
	
	hp_progressbar.value = int((_monster_current_health / _monster_health) * 100) 
